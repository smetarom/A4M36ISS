...
import com.redhat.brq.integration.model.OrderStatus;
...
public final class OrderStatusProvider {
    ...
    public static void orderInvalid(@ExchangeProperty("orderId") long orderId) {
        setStatus(orderId, RESOLUTION_CANCELLED, "The order is not valid");
    }
